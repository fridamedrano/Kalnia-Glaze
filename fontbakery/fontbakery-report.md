...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Mango (Latn, 77,000 speakers), Dii (Latn, 71,000 speakers), Cicipu (Latn, 44,000 speakers), Kom (Latn, 360,685 speakers), Ebira (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ejagham (Latn, 120,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Bafut (Latn, 158,146 speakers), South Central Banda (Latn, 244,000 speakers), Ekpeye (Latn, 226,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Lugbara (Latn, 2,200,000 speakers), Sar (Latn, 500,000 speakers), Makaa (Latn, 221,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Koonzime (Latn, 40,000 speakers), Mfumte (Latn, 79,000 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers), Yala (Latn, 200,000 speakers), Nateni (Latn, 100,000 speakers), Dan (Latn, 1,099,244 speakers), Aghem (Latn, 38,843 speakers), Southern Kisi (Latn, 360,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Basaa (Latn, 332,940 speakers), Gulay (Latn, 250,478 speakers), Zapotec (Latn, 490,000 speakers), Mundani (Latn, 34,000 speakers), Ma’di (Latn, 584,000 speakers), Fur (Latn, 1,230,163 speakers).</p>
 [code: soft-dotted]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, math, tai-le, canadian-aboriginal, malayalam, coptic, syriac, old-permic</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: tai-le, sinhala, thai, hanunoo, mende-kikakui, buginese, soyombo, batak, modi, sundanese, manichaean, tagalog, adlam, hanifi-rohingya, warang-citi, elbasan, balinese, canadian-aboriginal, masaram-gondi, rejang, cham, telugu, nko, gujarati, wancho, caucasian-albanian, tifinagh, tamil, lao, marchen, kharoshthi, myanmar, bassa-vah, tagbanwa, psalter-pahlavi, ahom, siddham, khojki, takri, javanese, grantha, kaithi, pahawh-hmong, devanagari, tirhuta, coptic, new-tai-lue, old-permic, limbu, tai-tham, meetei-mayek, mahajani, music, symbols, saurashtra, kannada, mongolian, tibetan, buhid, syriac, armenian, bengali, brahmi, sogdian, chakma, khudawadi, yi, duployan, zanabazar-square, hebrew, khmer, math, tai-viet, thaana, malayalam, newa, kayah-li, phags-pa, sharada, gurmukhi, syloti-nagri, dogra, gunjala-gondi, miao, osage, oriya, lepcha, mandaic, bhaiksuki</li>
