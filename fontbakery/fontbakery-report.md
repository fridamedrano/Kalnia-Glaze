...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Bete-Bendi (Latn, 100,000 speakers), Mfumte (Latn, 79,000 speakers), Lugbara (Latn, 2,200,000 speakers), Kom (Latn, 360,685 speakers), Dii (Latn, 71,000 speakers), Avokaya (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Aghem (Latn, 38,843 speakers), Bafut (Latn, 158,146 speakers), Mundani (Latn, 34,000 speakers), Ekpeye (Latn, 226,000 speakers), Ebira (Latn, 2,200,000 speakers), Basaa (Latn, 332,940 speakers), Nzakara (Latn, 50,000 speakers), Yala (Latn, 200,000 speakers), Southern Kisi (Latn, 360,000 speakers), Zapotec (Latn, 490,000 speakers), Dan (Latn, 1,099,244 speakers), Gulay (Latn, 250,478 speakers), Cicipu (Latn, 44,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Sar (Latn, 500,000 speakers), South Central Banda (Latn, 244,000 speakers), Koonzime (Latn, 40,000 speakers), Ejagham (Latn, 120,000 speakers), Igbo (Latn, 27,823,640 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Fur (Latn, 1,230,163 speakers), Ngbaka (Latn, 1,020,000 speakers), Nateni (Latn, 100,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ma’di (Latn, 584,000 speakers), Mango (Latn, 77,000 speakers).</p>
 [code: soft-dotted]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, tai-le, canadian-aboriginal, syriac, tifinagh, math, coptic, malayalam</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: tibetan, meetei-mayek, mandaic, gunjala-gondi, psalter-pahlavi, balinese, limbu, kharoshthi, cham, grantha, modi, sinhala, hebrew, lao, masaram-gondi, coptic, khojki, mahajani, warang-citi, bhaiksuki, batak, bengali, manichaean, tai-viet, sundanese, malayalam, tagalog, adlam, mongolian, buhid, nko, sharada, music, kaithi, kannada, old-permic, hanunoo, newa, gujarati, tagbanwa, thai, math, thaana, lepcha, zanabazar-square, brahmi, khudawadi, miao, siddham, tai-tham, kayah-li, mende-kikakui, oriya, symbols, myanmar, sogdian, saurashtra, armenian, pahawh-hmong, rejang, osage, yi, dogra, syloti-nagri, tamil, canadian-aboriginal, caucasian-albanian, khmer, takri, tifinagh, tirhuta, ahom, hanifi-rohingya, new-tai-lue, elbasan, bassa-vah, wancho, duployan, phags-pa, tai-le, devanagari, javanese, marchen, chakma, telugu, gurmukhi, soyombo, syriac, buginese</li>
