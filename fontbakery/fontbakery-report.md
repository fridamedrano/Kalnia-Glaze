...
<pre><code>- Contour 2 in glyph 'X': becomes underweight between wght=100,wdth=125 and wght=700,wdth=100.
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Aghem (Latn, 38,843 speakers), Zapotec (Latn, 490,000 speakers), Dii (Latn, 71,000 speakers), Fur (Latn, 1,230,163 speakers), Mango (Latn, 77,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Southern Kisi (Latn, 360,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Lugbara (Latn, 2,200,000 speakers), Dan (Latn, 1,099,244 speakers), Ma’di (Latn, 584,000 speakers), Bafut (Latn, 158,146 speakers), Ebira (Latn, 2,200,000 speakers), Yala (Latn, 200,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Avokaya (Latn, 100,000 speakers), Ekpeye (Latn, 226,000 speakers), Nzakara (Latn, 50,000 speakers), Kom (Latn, 360,685 speakers), Bete-Bendi (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Nateni (Latn, 100,000 speakers), Koonzime (Latn, 40,000 speakers), Sar (Latn, 500,000 speakers), Ejagham (Latn, 120,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mfumte (Latn, 79,000 speakers), South Central Banda (Latn, 244,000 speakers), Mundani (Latn, 34,000 speakers), Igbo (Latn, 27,823,640 speakers), Basaa (Latn, 332,940 speakers), Cicipu (Latn, 44,000 speakers), Gulay (Latn, 250,478 speakers).</p>
 [code: soft-dotted]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, canadian-aboriginal, syriac, tifinagh, old-permic, coptic, tai-le, math</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: devanagari, gurmukhi, tagalog, sogdian, coptic, brahmi, bhaiksuki, siddham, syriac, javanese, mende-kikakui, sharada, symbols, soyombo, adlam, gunjala-gondi, marchen, limbu, chakma, syloti-nagri, new-tai-lue, buhid, dogra, takri, thaana, phags-pa, hanunoo, modi, oriya, warang-citi, kannada, canadian-aboriginal, tamil, kharoshthi, elbasan, osage, math, cham, pahawh-hmong, malayalam, tirhuta, sundanese, khmer, khudawadi, newa, gujarati, mongolian, zanabazar-square, yi, tai-tham, buginese, manichaean, tibetan, tai-le, armenian, thai, hebrew, tai-viet, meetei-mayek, hanifi-rohingya, mahajani, tifinagh, bassa-vah, myanmar, ahom, wancho, rejang, saurashtra, sinhala, grantha, khojki, kaithi, lao, tagbanwa, bengali, music, miao, duployan, caucasian-albanian, masaram-gondi, batak, kayah-li, nko, old-permic, psalter-pahlavi, lepcha, mandaic, balinese, telugu</li>
